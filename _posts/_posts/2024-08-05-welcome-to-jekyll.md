...
Follow the instructions in the [Jekyll Docs]
 to complete the installation of the basic environment. [Git] also needs to be installed.
...
- [**Using **](#option-1) - Easy to upgrade, isolates irrelevant project files so you can focus on writing.
- [**GitHub**](#option-2) - Convenient for custom development, but difficult to upgrade. Unless you are familiar with Jekyll and are determined to tweak or contribute to this project, this approach is not recommended.
...
Sign in to GitHub to [fork **  **](https://github.com/), and then rename it to `USERNAME.github.io` (`USERNAME` means your username).
...
Also, if you'd like to self-host the static assets, please refer to the [_chirpy-static-assets_](https://github.com)
